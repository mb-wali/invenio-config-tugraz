...
# Datacite
INVENIO_CONFIG_DATACITE_API_USERNAME = "test"
INVENIO_CONFIG_DATACITE_API_PASSWORD = "test"
INVENIO_CONFIG_DATACITE_PREFIX = "test"
INVENIO_CONFIG_DATACITE_TEST_PREFIX = "test"
